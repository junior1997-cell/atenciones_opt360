...
Class Tipo
{
	...
	public function desactivar($idtipo_persona)	{
		...
		//add registro en nuestra bitacora
		$sql_bit = "INSERT INTO bitacora_bd( idcodigo, nombre_tabla, id_tabla, sql_d, id_user) VALUES (2, 'tipo_persona','$idtipo_persona','$idtipo_persona','$this->id_usr_sesion')";
		$bitacora = ejecutarConsulta($sql_bit); if ( $bitacora['status'] == false) {return $bitacora; }   
	...
	public function eliminar($idtipo_persona)
	{
		...
		//add registro en nuestra bitacora
		$sql = "INSERT INTO bitacora_bd( idcodigo, nombre_tabla, id_tabla, sql_d, id_user) VALUES (4, 'tipo_persona','$idtipo_persona','$idtipo_persona','$this->id_usr_sesion')";
